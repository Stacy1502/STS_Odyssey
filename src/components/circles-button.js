...
AFRAME.registerComponent('circles-button', {
  schema: {
    ...
    pedastal: {type:'boolean', default: true},
  },
  init: function () {
    ...
    if (CONTEXT_AF.data.pedastal === true)
    {
  ...
  update : function(oldData) {
    ...
    if ( (oldData.type !== data.type) && (data.type !== '') && CONTEXT_AF.data.pedastal === true) {
      if (data.type === 'box') {
    ...
    if ( (oldData.pedastal_color !== data.pedastal_color) && (data.pedastal_color !== '') && CONTEXT_AF.data.pedastal === true ) {
    ...
    if ( (oldData.diameter !== data.diameter) && (data.diameter !== '') && CONTEXT_AF.data.pedastal === true) {
